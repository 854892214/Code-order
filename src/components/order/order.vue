...
<div>
    ...
    <div class="mui-content mui-row mui-fullscreen" style="top:45px" v-if="isGetData">
        <div class="mui-col-xs-3 bg-white">
            <div id="segmentedControls" class="mui-segmented-control mui-segmented-control-inverted mui-segmented-control-vertical">
                <a class="mui-control-item Set-Width" :data-index="i" :href="'#content'+(i+1)" v-for="(item,i) in list" :key="i">{{item.name}}</a>
            </div>
        </div>
        <div id="segmentedControlContents" class="mui-col-xs-9" style="border-left: 1px solid #c8c7cc;">
            <div :id="'content'+(u+1)" class="mui-control-content" v-for="(item,u) in list" :key="u">
                ...
                <div class="flex" v-for="(n ,i) in item.goodsList" :key="i">
                    <div class="icon">
                        <img src="http://fuss10.elemecdn.com/c/cd/c12745ed8a5171e13b427dbc39401jpeg.jpeg?imageView2/1/w/114/h/114" alt width="57" height="57">
                    </div>
                    <div class="flex-cart" @click="GetIndex">
                        ...
                        <div v-if="n.hasOwnProperty('specificationInfoList')==false" class="nav-btn">
                            <img src="../../img/del.png" :data-nid="i" :data-lid="item.id" @click="minCount" v-show="n.num>0" class="transform cart-btn">
                            <span style="font-size:12px;padding-left: 0.5rem;padding-right: 0.5rem;" v-show="n.num>0">{{n.num}}</span>
    ...
    <div class="shopcart disabled" v-if="isGetData">
        ...
        <div class="content">
            ...
            <div class="content-right">
                <div class="pay" @click="orderConfirm()">{{this.$store.getters.GetIsAddOrder==true?'加单':'去下单'}}</div>
            </div>
        </div>
    </div>
    <!--购物车弹窗-->
    <mt-popup v-if="Count>0" v-model="popupVisible" position="bottom" style="width:100%;z-index:2019;margin-bottom:2.8rem;border-top-left-radius: 12px;border-top-right-radius: 12px;">
        <!--购物车内容-->
            ...
            <ul>
                <li class="food border-1px" v-for="(item,i) in ShopCartList" :key="i">
                    ...
                    <div class="inline-block list-float-right">
                        ...
                        <div class="mui-icon mui-icon-minus cart-btn padding" @click="ShopCartMin" :data-lid="item.id" :data-nid="i"></div>
                        <span class="ShopCart-num">{{item.num}}</span>
                        <div class="mui-icon mui-icon-plus cart-btn padding" @click="ShopCartAdd" :data-pid="i"></div>
